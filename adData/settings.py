"""
Django settings for adData project.
...
ALLOWED_HOSTS = ['thebluecoder09.pythonanywhere.com', '127.0.0.1']
...
WSGI_APPLICATION = 'adData.wsgi.application'
